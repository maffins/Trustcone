...
<div class="documents index">
        ...
        <div class="col-md-3">
            <div class="actions">
                ...
                ?>
                            ...
                            <li ><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('Capture Documents'), array('controller' => 'Documents', 'action' => 'add'), array('escape' => false)); ?></li>
    ...
    <?php if($canapprove):?>
	<p class='btn btn-info'>Official Documents<p/>
    <br style="clear: both" />
