		...
		<div class="col-md-12">
			<table cellpadding="0" cellspacing="0" class="table table-striped" style="background-color: #; width: 1000px; margin: 0 auto">
				...
				<tr style="background-color: #156F30">
					<td colspan="5" style="text-align: center; font-size: 20px"><b>TOURISM, ENVIRONMENT AFFAIRS AND AGRICULTURE SECTION 80 COMMITTEE: <?php echo $Meeting['Meeting']['name']; ?></b>&nbsp;</td>
				</tr>
