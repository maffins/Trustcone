				...
				<div class="row">
					<div class="col-md-12">
						<div class="page-header">
							<h1><?php echo __('Resend Community services section 80 committee Documents Messages'); ?></h1>
						</div>
					</div>
				</div>

          <div class="col-md-9">
					<?php echo $this->Form->create('CommunityService', array('role' => 'form', 'enctype' => 'multipart/form-data')); ?>
