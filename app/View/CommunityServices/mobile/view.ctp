...
<div class="col-md-5">
    <table cellpadding="0" cellspacing="0" class="table table-striped" style="background-color: #156F30; margin: 0 auto">
        ...
        <tr style="background-color: #156F30">
            <td nowrap colspan="" style="text-align: center; font-size: 17px"><b>COMMUNITY SERVICES SECTION 80 COMMITEE MEETING:<br /> <?php echo $Meeting['Meeting']['name']; ?></b>&nbsp;</td>
        </tr>
        ...
        <tr style="border: 1px solid #156F30">
            <td ><?php
                                    echo $this->Html->link($separatecvrs['document_name'], array( 'action' => 'sendFile', $separatecvrs['MeetingSeparatecovers']['id'], 4), array('target' => '_blank'));
                ?>
                <br />
                <?php
                                    echo $this->Html->link('Download', array( 'action' => 'sendFile', $separatecvrs['id'], 4), array('target' => '_blank'));
                ?>&nbsp;</td>
        </tr>
        <tr>
            <td><b><i><?php
                      echo $this->Html->link('Cant access/Download file?', array( 'action' => 'cantdownload', $separatecvrs['id'],4));
                        ?>&nbsp;</b></i>
            </td>
        </tr>
        <?php endforeach; ?>
