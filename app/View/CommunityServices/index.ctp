	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Community services section 80 Committee Documents'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
		...
		<div class="col-md-3" style="">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li style="<?php if($controller == 'CommunityServices'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Community Services Section 80'), array('controller' => 'CommunityServices', 'action' => 'add'), array('escape' => false)); ?> </li>
							</ul>
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped" style="margin: 0 auto">
				...
				<tr>
					...
					<td class="actions" <?php if($logged_user['id'] != 51 && $logged_user['id'] != 1 && $logged_user['id'] != 245) :?> style ="display:none" <?php endif;?> >
