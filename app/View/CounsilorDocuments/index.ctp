    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Council Meetings List'); ?></h1>
            </div>
        </div><!-- end col md 12 -->
    </div><!-- end row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                          <?php if( in_array(23, $permissions) ):?>
                            <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Council Documents'), array('controller' => 'CounsilorDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
                          <?php endif;?>
                        </ul>
                    </div><!-- end body -->
                </div><!-- end panel -->
        ...
        <?php endif;?>
             ...
             <table cellpadding="0" cellspacing="0" class="table table-striped" style="margin: 0 auto">
                ...
                <tr>
                    ...
                    <th ><?php echo $this->Paginator->sort('meeting creation date'); ?></th>
                    <th style="display: none"><?php echo $this->Paginator->sort('created'); ?></th>
                    <th style="display: none"><?php echo $this->Paginator->sort('minutes creation date'); ?></th>
                    <th class="actions" <?php if($logged_user['id'] != 51 && $logged_user['id'] != 245 && $logged_user['id'] != 1) :?> style ="display:none" <?php endif;?> ></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td >&nbsp;
                        <?php echo $this->Html->link($meeting['Meeting']['name'], array('action' => 'view', $meeting['Meeting']['id']), array('escape' => false)); ?>
                           </td>
                    <td   style="display: none"><?php echo h($meeting['Meeting']['user_id']); ?>&nbsp;</td>
                    <td ><?php echo h(substr($meeting['Meeting']['created'], 0, 10)); ?>&nbsp;</td>
                    <td style="display: none">&nbsp;
                        <?php
                            if($meeting['Meeting']['minutes'])
                            {
                                echo $this->Html->link($meeting['Meeting']['minutes_og_meeting'], array('action' => 'sendFile', $meeting['Meeting']['id'],6), array('escape' => false));
                            } else {
                                if($logged_user['id'] == 51 )
                                {
                                    echo $this->Html->link('Add Minutes', array('action' => 'addminutes', $meeting['Meeting']['id']), array('escape' => false));
                                } else {
                    ...
                    <td style="display: none"><?php if($meeting['Meeting']['minutes']) { echo h(substr($meeting['Meeting']['minutes_created'], 0, 10)); } else { echo '-';} ?>&nbsp;</td>
                    <td class="actions" <?php  if($logged_user['id'] != 51 && $logged_user['id'] != 1) :?> style ="display:none" <?php endif;?> >
                        ...
                        <?php if($logged_user['id'] == 51 || $logged_user['id'] == 1 ):?>
