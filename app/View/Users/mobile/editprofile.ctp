<div class="users form  form-group">
    ...
    <fieldset>
        ...
        echo $this->Form->input('department_id', ['disabled' => 'disabled']);
        echo "<br style='clear:both' />";
        echo $this->Form->input('user_type_id', ['disabled' => 'disabled']);
        echo "<br style='clear:both' />";
        ...
        echo "<br style='clear:both' />";
        echo $this->Form->input('password', ['label' => 'Password', 'value' => '', 'required' => false]);
        echo "<br style='clear:both' />";
