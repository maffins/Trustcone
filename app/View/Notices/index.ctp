    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('Council Notices List'); ?></h1>
            </div>
        </div><!-- end col md 12 -->
    </div><!-- end row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                          <?php if( in_array(23, $permissions) ):?>
                            <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Notice'), array('controller' => 'Notices', 'action' => 'add'), array('escape' => false)); ?> </li>
                          <?php endif;?>
                        </ul>
                    </div><!-- end body -->
                </div><!-- end panel -->
            ...
            <div class="col-md-9" >
             ...
             <table cellpadding="0" cellspacing="0" class="table table-striped" style="margin: 0 auto">
                ...
                <tr>
                    ...
                    <th ><?php echo $this->Paginator->sort('notice creation date'); ?></th>
                    <th class="actions" <?php if($logged_user['id'] != 51 && $logged_user['id'] != 1) :?> style ="display:none" <?php endif;?> ></th>
                </tr>
                </thead>
                <tbody>
