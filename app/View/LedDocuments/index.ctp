	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('LED, SMALL BUSINESS, SPATIAL PLANNING AND LAND USE MANAGEMENT SECTION 80 COMMITTEE'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
         ...
         <?php endif;?>
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<?php if( in_array(13, $permissions) ):?>
								<li style="<?php if($controller == 'EightyDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New LED'), array('controller' => 'LedDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
							<?php endif; ?>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped" style="margin: 0 auto">
				...
				<tr>
					...
					<th class="actions" <?php if($logged_user['id'] != 51 && $logged_user['id'] != 1 && $logged_user['id'] != 245) :?> style ="display:none" <?php endif;?> ></th>
				</tr>
				</thead>
				<tbody>
				...
				<tr>
					...
					<td class="actions" <?php if($logged_user['id'] == 51 || $logged_user['id'] == 1 || $logged_user['id'] == 153 || $logged_user['id'] == 245) :?> style ="display:block"<?php else:?> style ="display:none"  <?php endif;?> >
						...
						<?php if($logged_user['id'] == 51 || $logged_user['id'] == 1 || $logged_user['id'] == 153 || $logged_user['id'] == 245):?>
