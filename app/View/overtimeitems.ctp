		...
		<td >
			...
			?>&nbsp;
					 ...
					 ?>&nbsp;</td>
						...
						if ( $overtime['Overtime']['tracker'] != 5 && $overtime['Overtime']['tracker'] != 6 ) {
							if($approver == 3):?>
								<input type="text" id='rate<?php echo $overtime['Overtime']['id']?>' value="<?php echo $overtime['Overtime']['rate'] ?>" /> <input type="button" id='button<?php echo $overtime['Overtime']['id']?>' value="Total amount(R)" onclick="saveRate('<?php echo $overtime['Overtime']['id']?>', 'rate<?php echo $overtime['Overtime']['id']?>', 'button<?php echo $overtime['Overtime']['id']?>')" />
							<?php endif;
						}
							?>
					</td>
			...
			<div class="form-group">
				...
				if ( $overtime['Overtime']['tracker'] != 5 && $overtime['Overtime']['tracker'] != 6 ) {
					if($approver == 3):?>
						 <input type="button" id='button<?php echo $overtimeRequester['OvertimeRequester']['id']?>' value="Send to CFO" onclick="submittoCFO('<?php echo $overtimeRequester['OvertimeRequester']['id']?>')" />
					<?php endif;
				}
					?>
			</div>
