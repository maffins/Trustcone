<div class="users index">
	<h2><?php echo __('ALL MEMBERS OF SECTION: '.$section['Section']['name']); ?></h2>
    <style>
        .paginate_button {
            padding: 5px;
	...
	<tr>
		...
		<td class="actions" style="width: 150px">
			<?php echo $this->Html->link(__('Remove user'), array('controller' => 'Users','action' => 'removeuser', $user['User']['id'], $section['Section']['id'])); ?> <span class="glyphicon glyphicon-edit"></span>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
