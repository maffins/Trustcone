	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('HUMAN SETTLEMENT COMMITEE SECTION 80 COMMITTEE'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<?php if( in_array(13, $permissions) ):?>
								<li style="<?php if($controller == 'EightyDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Human Settlement'), array('controller' => 'HumanDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
							<?php endif; ?>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
