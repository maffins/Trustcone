				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li style="<?php if($controller == 'EightyDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Public safity Committee'), array('controller' => 'PublicSafityDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
