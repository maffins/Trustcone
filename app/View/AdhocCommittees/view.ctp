		...
		<div class="col-md-12">
			<table cellpadding="0" cellspacing="0" class="table table-striped" style="background-color: #; width: 1000px; margin: 0 auto">
				...
				<tr style="background-color: #156F30">
					<td colspan="5" style="text-align: center; font-size: 20px"><b>ADHOC COMMITTEE: <?php echo $Meeting['Meeting']['name']; ?></b>&nbsp;</td>
				</tr>
...
?>
				...
				<tr>
					...
					<th colspan="2"><?php echo $this->Paginator->sort('document name'); ?></th>
					<th><?php echo $this->Paginator->sort('created on'); ?></th>
					<th class="actions" <?php if($logged_user['id'] == 51 || $logged_user['id'] == 1 || $logged_user['id'] == 245) :?> style ="display:block" <?php else:?> style ="display:none" <?php endif;?> >
				</tr>
				</thead>
				<tbody>
				<?php
