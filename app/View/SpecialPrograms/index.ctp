	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Special programs section 80 Committee Documents'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li style="<?php if($controller == 'SpecialPrograms'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Special Programs Section 80'), array('controller' => 'SpecialPrograms', 'action' => 'add'), array('escape' => false)); ?> </li>
							</ul>
