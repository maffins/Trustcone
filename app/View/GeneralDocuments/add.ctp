	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('CAPTURE GENERAL MEETING DOCUMENTS'); ?></h1>
			</div>
		</div>
	</div>
...
<?php endif; ?>
	<div class="col-md-9">
			...
			<br />
			<div class="form-group">
				<?php echo $this->Form->input('notice.', array('class' => 'form-control', 'label'=>'Notice', 'placeholder' => 'Notices to upload',  'type' => 'file', 'multiple' => 'multiple'));?>
			</div>
			<br />
				...
				<div class="collapse" id="collapseExample">
					...
					<br style="clear:both" />
						...
						<div class="form-group">
							...
							<?php echo $this->Form->checkbox('sendemail', array('class' => 'form-control', 'checked' => 'checked', 'label'=>'Send emails'));?>
						</div>
						<br style="clear:both" />
							<div class="form-group">
								<label for="sendemail">Send sms's(only)</label>
								<?php echo $this->Form->checkbox('sendsms', array('class' => 'form-control', 'checked' => 'checked',  'label'=>'Send sms'));?>
							</div>
