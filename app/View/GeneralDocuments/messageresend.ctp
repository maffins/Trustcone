			<div class="GeneralDocument form">

				<div class="row">
					<div class="col-md-12">
						<div class="page-header">
							<h1><?php echo __('RESEND COUNCIL MEETING MANAGEMENT MESSAGES'); ?></h1>
						</div>
					</div>
				</div>
          ...
          <div class="col-md-9">
					...
					<div style="display:none">
						...
						<br style="clear:both" />
						<div class="form-group">
							<?php echo $this->Form->input('files.', array('class' => 'form-control', 'label'=>'Files to send',  'type' => 'file', 'multiple' => 'multiple'));?>
						</div>
				 </div>
<br style="clear:both" />
					...
					<br style="clear:both" />
						<div class="form-group">
							<label for="sendemail">Send sms</label>
