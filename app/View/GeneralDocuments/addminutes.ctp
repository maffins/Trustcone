<div class="GeneralDocuments form">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h2><?php echo __('Capture Meeting Minutes'); ?></h2>
			</div>
		</div>
	</div>
	...
	<div class="col-md-3" style="display: none">
		<div class="actions">
			<div class="panel panel-default">
                ...
                ?>
						<li style="display: none"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('Council Documents'), array('controller' => 'GeneralDocuments', 'action' => 'index'), array('escape' => false)); ?> </li>
						...
						<li  style="display: none"><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('Council Documents'), array('controller' => 'GeneralDocuments', 'action' => 'index'), array('escape' => false)); ?></li>

						<li ><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('Capture Documents'), array('controller' => 'GeneralDocuments', 'action' => 'add'), array('escape' => false)); ?></li>
...
<?php endif; ?>
	<div class="col-md-9">
			<?php echo $this->Form->create('GeneralDocument', array('role' => 'form', 'enctype' => 'multipart/form-data')); ?>

			<div class="form-group" style="display: block;">
				<?php echo $this->Form->input('id', array('class' => 'form-control', 'value' => $meeting_id));?>
			</div>

			<h4>Meeting name</h4>

			<div class="form-group">
				<?php echo $Meeting[0]['Meeting']['name']?>
			</div>

			<h4>Current meeting minutes</h4>

			<div class="form-group">
				<?php echo $this->Form->input('minutes', array('class' => 'form-control', 'label'=>'Current Meeting minutes', 'placeholder' => 'Documents to upload',  'type' => 'file', 'multiple' => 'multiple'));?>
			</div>
			<br /><br />
			<div class="form-group">
				<?php echo $this->Form->submit(__('Upload minutes'), array('class' => 'btn btn-default')); ?>
			</div>
