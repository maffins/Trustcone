    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <h1><?php echo __('General Meetings List'); ?></h1>
            </div>
        </div><!-- end col md 12 -->
    </div><!-- end row -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                          <?php if( in_array(23, $permissions) ):?>
                            <li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New General Documents'), array('controller' => 'GeneralDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
                          <?php endif;?>
                        </ul>
                    </div><!-- end body -->
                </div><!-- end panel -->
