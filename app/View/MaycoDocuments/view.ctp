		...
		<div class="col-md-12">
			<table cellpadding="0" cellspacing="0" class="table table-striped" style="background-color: #; width: 1000px; margin: 0 auto">
				...
				<tr style="background-color: #156F30">
					<td colspan="5" style="text-align: center; font-size: 20px"><b>MAYCO MEETING: <?php echo $Meeting['Meeting']['name']; ?></b>&nbsp;</td>
				</tr>
...
?>
				...
				<tr style="border: 1px solid #">
					...
					<td><?php
                                    echo $this->Html->link($agend['MeetingAgenda']['original_name'], array( 'action' => 'sendFile', $agend['MeetingAgenda']['id'],1), array('target' => '_blank'));
						?>&nbsp;
						<br />
						<?php
...
?>
				...
				<tr style="border: 1px solid #">
					...
					<td><?php
                                    echo $this->Html->link($minutes['MeetingMinutes']['original_name'], array( 'action' => 'sendFile', $minutes['MeetingMinutes']['id'], 2), array('target' => '_blank'));
						?>&nbsp;
						<br />
						<?php
...
?>
				...
				<tr style="border: 1px solid #">
					...
					<td><?php
                                    echo $this->Html->link($item['MeetingItems']['original_name'], array( 'action' => 'sendFile', $item['MeetingItems']['id'], 3), array('target' => '_blank'));
						?>&nbsp;
						<br />
						<?php
...
?>
				...
				<tr style="border: 1px solid #fff862">
					...
					<td><?php
                                    echo $this->Html->link($attachment['MeetingAttachments']['original_name'], array( 'action' => 'sendFile', $attachment['MeetingAttachments']['id'], 4), array('target' => '_blank'));
						?>&nbsp;
						<br />
						<?php
				...
				<tr style="border: 1px solid #fff862">
					...
					<td><?php
                                    echo $this->Html->link($sptr['MeetingSeparatecovers']['original_name'], array( 'action' => 'sendFile', $sptr['MeetingSeparatecovers']['id'],5), array('target' => '_blank'));
						?>
						<br />
						<?php
...
?>
            ...
            <tr style="border: 1px solid #">
                ...
                <td><?php
                                echo $this->Html->link($adend['MeetingAddendum']['original_name'], array( 'action' => 'sendFile', $adend['MeetingAddendum']['id'],8), array('target' => '_blank'));
                    ?>
                    <br />
                    <?php
