...
<?php
   ...
   // print_r($logged_user);
    $manager_approvers  = ['0' => 146, '1' => 147, '2' => 148, '3' => 149, '4' => 150, '5' => 151, '6' => 152, '7' => 153 ];
   //This is for the permissions now
   $director_approvers = ['0' => 116, '1' => 119, '2' => 122, '3' => 125, '4' => 128, '5' => 131, '6' => 134, '7' => 137 ];
?>
        ...
        <tr>
            <td colspan="3" style="text-align: center;vertical-align: text-top">
                <?php
                        ...
                        $message = __("Welcome you are logged in as ").$who." | ".$logged_user['fname'].' '.$logged_user['sname'];
                ...
                <?php
                    ...
                    $allControllers['ChairDocument'] = 17;
                    ...
                    $allControllers['SpecialPrograms'] = 26;
                ?>
                <div class="actions">
                            ...
                            <ul class="nav nav-pills ">
                                <?php if( in_array(21, $permissions) ):?>
                                     <li style="<?php if($controller == 'Documents'){ echo 'background:#658B6E';} ?>" >
                                         <?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('OFFICIAL DOCUMENTS'), array('controller' => 'OfficialDocuments', 'action' => 'index'), array('escape' => false)); ?></li>
                                <?php endif?>
                                ...
                                <li style="<?php if($controller == 'PublicSafityDocuments' || $controller == 'InfrastructureTechnicalServices' || $controller == 'IdpPolicyMonitoringDocuments' || $controller == 'CorporateServicesDocuments' || $controller == 'EightyDocuments' || $controller == 'FinanceDocuments' || $controller == 'CommunityServices'){ echo 'background:#658B6E';} ?>">
                                    ...
                                    <ul class="dropdown-menu" role="menu" style="background-color: #2F575D">
                                        ...
                                        <li style="<?php if($controller == 'FinanceDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-euro"></span>&nbsp;&nbsp;'.__('Finance Committee'), array('controller' => 'FinanceDocuments', 'action' => 'index'), array('escape' => false)); ?> </li>
                                        <?php endif?>
                                        ...
                                        <li style="<?php if($controller == 'TourismDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-folder-close"></span>&nbsp;&nbsp;'.__('Tourism, Environment Affairs and Agriculture Committee'), array('controller' => 'TourismDocuments', 'action' => 'index'), array('escape' => false)); ?> </li>
                                        <?php endif?>
                                ...
                                <?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('SECTION 79 COMMITTEES MEETINGS DOCUMENTS'), array('controller' => 'SeventyNineDocuments', 'action' => 'index'), array('escape' => false, 'class' => 'dropdown-toggle', 'data-toggle' => 'dropdown')); ?>
                                        <ul class="dropdown-menu" role="menu" style="background-color: #2F575D">
                                            ...
                                            <li style="<?php if($controller == 'RevenueDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-info-sign"></span>&nbsp;&nbsp;'.__('Revenue Enhancement Committee'), array('controller' => 'RevenueDocuments', 'action' => 'index'), array('escape' => false)); ?> </li>
                                            <?php endif?>
                                ...
                                <?php if( in_array(154, $permissions) ):?>
                                    <li style="height: 61px !important;<?php if($controller == 'OvertimeRequesters'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('PRE APPROVAL OVERTIMES'), array('controller' => 'OvertimeRequesters', 'action' => 'index'), array('escape' => false)); ?></li>
                                <?php endif?>

                                <?php if( in_array(138, $permissions) ):?>
                                    <li style="height: 61px !important;<?php if($controller == 'Overtimes'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('OVERTIMES'), array('controller' => 'Overtimes', 'action' => 'index'), array('escape' => false)); ?></li>
                                <?php endif?>
                                ...
                                <?php endif?>
                                <?php if( in_array(138, $permissions)  ):?>
                                    <li style="<?php if($controller == 'Overtimes'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;'.__('OVERTIME REPORTs'), array('controller' => 'Overtimes', 'action' => 'reports'), array('escape' => false)); ?> </li>
                                <?php endif?>

                                        <?php if( in_array(77, $permissions) ):?>
                                    <li style="<?php if($controller == 'Users'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('DASHBOARD'), array('controller' => 'Users', 'action' => 'dashboard'), array('escape' => false)); ?> </li>
                                <?php endif ?>

                               <?php if($logged_user['id'] == 1 || $logged_user['id'] == 51 || $logged_user['id'] == 245):?>
