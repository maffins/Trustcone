			<div class="ExcoDocument form">

				<div class="row">
					<div class="col-md-12">
						<div class="page-header">
							<h1><?php echo __('EXCO MEETING DOCUMENTS'); ?></h1>
						</div>
					</div>
				</div>
                ...
                ?>
                                    ...
                                    <li style="display: none"><?php echo $this->Html->link('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;'.__('MAYCO Documents'), array('controller' => 'ExcoDocuments', 'action' => 'index'), array('escape' => false)); ?> </li>
                                    <?php endif ; ?>
            ...
            <?php endif;?>
                <div class="col-md-9">
					<?php echo $this->Form->create('ExcoDocument', array('role' => 'form', 'enctype' => 'multipart/form-data')); ?>
