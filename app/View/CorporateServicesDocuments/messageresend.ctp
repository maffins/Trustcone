				...
				<div class="row">
					<div class="col-md-12">
						<div class="page-header">
							<h1><?php echo __('Resend CORPORATE SERVICES SECTION 80 COMMITTEE Messages'); ?></h1>
						</div>
					</div>
				</div>

          <div class="col-md-9">
					<?php echo $this->Form->create('CorporateServicesDocument', array('role' => 'form', 'enctype' => 'multipart/form-data')); ?>
