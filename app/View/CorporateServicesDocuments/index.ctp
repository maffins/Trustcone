	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('CORPORATE SERVICES SECTION 80 COMMITEE'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<?php if( in_array(33, $permissions) ):?>
								<li style="<?php if($controller == 'EightyDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New Corporate Services Section 80'), array('controller' => 'CorporateServicesDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
							<?php endif; ?>
						</ul>
