					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<?php if( in_array(13, $permissions) ):?>
								<li style="<?php if($controller == 'EightyDocuments'){ echo 'background:#658B6E';} ?>"><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New IDP Polic Services'), array('controller' => 'IdpPolicyMonitoringDocuments', 'action' => 'add'), array('escape' => false)); ?> </li>
							<?php endif; ?>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
