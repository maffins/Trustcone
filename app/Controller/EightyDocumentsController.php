    ...
    /**
    * EightyDocuments Controller
    *
    * @property EightyDocument $EightyDocument
    * @property PaginatorComponent $Paginator
    * @property FlashComponent $Flash
    * @property SessionComponent $Session
    */
    class EightyDocumentsController extends AppController {
      ...
      */
      ...
      public function viewmembers() {
    		...
    		{
    				if( in_array(8, unserialize($user['User']['permissions'])) )
    				{
    						$allmembers[] = $user;
    				}
    		}
        ...
        public function committeedetails() {
      	...
      	public function messageresend() {
      			if ($this->request->is('post')) {
      				$message = $this->request->data['EightyDocument']['message'];
      				$subject = $this->request->data['EightyDocument']['subject'];

      				if(!$subject)
      				{
      					$subject = "Joint Section 80 Committee: LED, Tourism & Human Settlement documents are posted.";
      				}
      				if(!$message)
      				{
      					$message = "Joint Section 80 Committee: LED, Tourism & Human Settlement documents are posted. Please login to http://trustconetest.co.za/users/login to view documents.";
      				}

      				if($this->request->data['EightyDocument']['sendsms']){
      					 $this->sendsms($message);
      				}
      				if($this->request->data['EightyDocument']['sendemail']){
      				...
      				return $this->redirect(array('Controller' => 'EightyDocument', 'action' => 'committeedetails'));
      		}
      	}
    ...
    */
    ...
    $allmeetings = $this->Meeting->find('all', ['fields'=>'DISTINCT name, idcounter, created, user_id', 'conditions'=>['Meeting.type' => 3]]);
    ...
    $auditTrail['AuditTrail']['contents'] = "Opened the meetings page for Eighty  ".$_SERVER['REMOTE_ADDR'];
    if( !$this->AuditTrail->save($auditTrail))
    {
    die('There was a problem trying to save the audit trail for viewing all Eighty  documents');
    }
    }
    ...
    if($which == 5)
    {
        ...
        $directory = "eighty_separatecovers";
    }
    ...
    if($which == 8)
    {
        ...
        $tafura    = "eighty_addendum";
        $directory = "eighty_addendum";
    }

    $options = array('conditions' => array($tafura.'.' . $this->$tafura->primaryKey => $id, $tafura.'.type' => 3));
    ...
    $auditTrail['AuditTrail']['contents'] = "Opened to view Eighty  document with id ".$id." item ".$directory." ".$_SERVER['REMOTE_ADDR'];
    if( !$this->AuditTrail->save($auditTrail))
    {
    die('There was a problem trying to save the audit trail for viewing Eighty  document');
    }
    ...
    */
    public function view($id = null) {
        ...
        $options = array('conditions' => array('Meeting.' . $this->Meeting->primaryKey => $id, 'Meeting.type' => 3));
        ...
        */
        $this->loadModel('MeetingAgenda');
        $options1 = array('conditions' => array('MeetingAgenda.meeting_id' => $id, 'MeetingAgenda.type' => 3));
        ...
        */
        ...
        $options2 = array('conditions' => array('MeetingMinutes.meeting_id' => $id, 'MeetingMinutes.type' => 3));
        ...
        */
        ...
        $options3 = array('conditions' => array('MeetingItems.meeting_id' => $id, 'MeetingItems.type' => 3));
        ...
        */
        ...
        $options4 = array('conditions' => array('MeetingAttachments.meeting_id' => $id, 'MeetingAttachments.type' => 3));
        ...
        $options5 = array('conditions' => array('MeetingSeparatecovers.meeting_id' => $id, 'MeetingSeparatecovers.type' => 3));
        ...
        /*
				 ...
				 */
				$this->loadModel('MeetingNotice');
				$options6 = array('conditions' => array('MeetingNotice.meeting_id' => $id, 'MeetingNotice.type' => 3));
				 ...
				 */
				$this->loadModel('MeetingAddendum');
				$options7 = array('conditions' => array('MeetingAddendum.meeting_id' => $id, 'MeetingAddendum.type' => 3));
        ...
        $this->loadModel('AuditTrail');
        $auditTrail['AuditTrail']['user_id'] = $this->Auth->user('id');
        $auditTrail['AuditTrail']['event_description'] = "Viewing the meeting details for Eighty  meeting id ".$id." ip ".$_SERVER['REMOTE_ADDR'];

        $auditTrail['AuditTrail']['contents'] = "Viewing the meeting details for Eighty  meeting id ".$id." ".$_SERVER['REMOTE_ADDR'];
        if( !$this->AuditTrail->save($auditTrail))
        {
        die('There was a problem trying to save the audit trail for viewing Eighty  document');
        }
    ...
    */
    public function add() {
        ...
        $meeting['Meeting']['name']    = $meetingName = $this->request->data['EightyDocument']['meeting'];
        $meeting['Meeting']['type']    = 3;
            ...
            $previousMeeting = $this->Meeting->find('first', array('conditions' => array('Meeting.type' => 3),
        ...
        $this->loadModel('MeetingAgenda');
        $agendaDocuments = $this->request->data['EightyDocument']['agenda'];
        $agendaDetails = [];
        ...
        foreach( $agendaDocuments as $upload)
        {
            ...
            move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_agenda' . DS . $file['name']);
        ...
        $agendaDetails['MeetingAgenda']['type']       = 3;
        ...
        $this->loadModel('MeetingMinute');
        $minutesDocuments = $this->request->data['EightyDocument']['minutes'];
        $minutesDetails = [];
        ...
        $original_name = $file['name'];
        $file['name'] = preg_replace('/\s+/', '_', $file['name']);
        move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_minutes' . DS . $file['name']);
        //prepare the filename for database entry
        ...
        $minutesDetails['MeetingMinute']['type']       = 3;
        ...
        $this->loadModel('MeetingItem');
        $itemsDocuments = $this->request->data['EightyDocument']['items'];
        $itemsDetails = [];
        ...
        $original_name = $file['name'];
        $file['name'] = preg_replace('/\s+/', '_', $file['name']);
        move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_items' . DS . $file['name']);
        //prepare the filename for database entry
        ...
        $itemsDetails['MeetingItem']['type']       = 3;
        ...
        $this->loadModel('MeetingAttachment');
        $attachmentDocuments = $this->request->data['EightyDocument']['attachments'];
        $attachmentDetails = [];
        ...
        $original_name = $file['name'];
        $file['name'] = preg_replace('/\s+/', '_', $file['name']);
        move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_attachments' . DS . $file['name']);
        //prepare the filename for database entry
        ...
        $attachmentDetails['MeetingAttachment']['type']       = 3;
        ...
        $this->loadModel('MeetingSeparatecover');
        $separateCoversDocuments = $this->request->data['EightyDocument']['separatecovers'];
        $separeCoverDetails = [];
        ...
        foreach( $separateCoversDocuments as $upload)
        {
            ...
            if ($meetingName) {
                ...
                $original_name = $file['name'];
                $file['name'] = preg_replace('/\s+/', '_', $file['name']);
                move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_separatecovers' . DS . $file['name']);
                //prepare the filename for database entry
            ...
            $separeCoverDetails['MeetingSeparatecover']['type']       = 3;
        ...
        $this->loadModel('MeetingAddendum');
        $addendumDocuments = $this->request->data['EightyDocument']['addendum'];
        $addendumDetails = [];
        ...
        foreach( $addendumDocuments as $upload)
        {
            ...
            if ($meetingName) {
                ...
                $original_name = $file['name'];
                $file['name'] = preg_replace('/\s+/', '_', $file['name']);
                move_uploaded_file($file['tmp_name'], WWW_ROOT . 'uploads' . DS . 'eighty_addendum' . DS . $file['name']);
                //prepare the filename for database entry
            ...
            $addendumDetails['MeetingAddendum']['type'] = 3;
        ...
        $this->loadModel('AuditTrail');
        $auditTrail['AuditTrail']['user_id'] = $this->Auth->user('id');
        $auditTrail['AuditTrail']['event_description'] = "Adding a Eighty  document ".$_SERVER['REMOTE_ADDR'];

        $auditTrail['AuditTrail']['contents'] = "Adding a Eighty  document ".$_SERVER['REMOTE_ADDR'];
        if( !$this->AuditTrail->save($auditTrail))
        {
        die('There was a problem trying to save the audit trail for adding Eighty  document');
        }

        $notifications = $this->request->data['EightyDocument']['notifications'];
        unset($this->request->data['EightyDocument']['notifications']);

        $sendemail = $this->request->data['EightyDocument']['sendemail'];
        unset($this->request->data['EightyDocument']['sendemail']);

        $sendsms = $this->request->data['EightyDocument']['sendsms'];
        unset($this->request->data['EightyDocument']['sendsms']);

        //This is for sending emails to others not part of counciler user type
        if($notifications) {
          if($sendsms) {
            $this->sendsms($this->request->data['EightyDocument']['message']);
          }
          if($sendemail) {
            $this->sendemail($this->request->data['EightyDocument']['message'], $this->request->data['EightyDocument']['subject']);
          }
        }else {
          $this->sendsms();
          $this->sendemail();
        ...
        $this->Flash->success(__('Uploaded successfuly.'));
        return $this->redirect(array('Controller' => 'EightyDocument', 'action' => 'index'));

     }

        $this->loadModel('AuditTrail');
        $auditTrail['AuditTrail']['user_id'] = $this->Auth->user('id');
        $auditTrail['AuditTrail']['event_description'] = "Open the add Eighty  add page ".$_SERVER['REMOTE_ADDR'];

        $auditTrail['AuditTrail']['contents'] = "Open the add Eighty  document page ".$_SERVER['REMOTE_ADDR'];
        if( !$this->AuditTrail->save($auditTrail))
        {
            die('There was a problem trying to save the audit trail for editing Eighty  document');
        }

        $users = $this->EightyDocument->User->find('list');
    ...
    $this->loadModel('Meeting');
    $options1 = array('conditions' => array('Meeting.' . $this->Meeting->primaryKey => $file[$tafura]['meeting_id'], 'Meeting.type' => 3));
    ...
    ->template('cantdownload_Eighty ', 'default')
    ->emailFormat('html')
    ...
    $this->loadModel('AuditTrail');
    $auditTrail['AuditTrail']['user_id'] = $this->Auth->user('id');
    $auditTrail['AuditTrail']['event_description'] = "Eighty  member tried to view document ".$docname." with id ".$id." item ".$directory." ".$_SERVER['REMOTE_ADDR']." But was not successful";
    ...
    */
    ...
    if (!$this->EightyDocument->exists($id)) {
    throw new NotFoundException(__('Invalid Eighty  document'));
    }
    if ($this->request->is(array('post', 'put'))) {
    if ($this->EightyDocument->save($this->request->data)) {
    $this->Session->setFlash(__('The Eighty  document has been saved.'), 'default', array('class' => 'alert alert-success'));
    return $this->redirect(array('action' => 'index'));
    } else {
    $this->Session->setFlash(__('The Eighty  document could not be saved. Please, try again.'), 'default', array('class' => 'alert alert-danger'));
    }
    } else {
    $options = array('conditions' => array('EightyDocument.' . $this->EightyDocument->primaryKey => $id));
    $this->request->data = $this->EightyDocument->find('first', $options);
    }
    $users = $this->EightyDocument->User->find('list');
    $this->set(compact('users'));
    }
    ...
    */
    ...
    $this->EightyDocument->id = $id;
    if (!$this->EightyDocument->exists()) {
    throw new NotFoundException(__('Invalid Eighty  document'));
    }
    $this->request->onlyAllow('post', 'delete');
    if ($this->EightyDocument->delete()) {
    $this->Session->setFlash(__('The Eighty  document has been deleted.'), 'default', array('class' => 'alert alert-success'));
    } else {
    $this->Session->setFlash(__('The Eighty  document could not be deleted. Please, try again.'), 'default', array('class' => 'alert alert-danger'));
    }
    return $this->redirect(array('action' => 'index'));
    }
    ...
    */
    ...
    $meeting_id = $this->request->data['EightyDocument']['meeting_id'];
    ...
    $options = array('conditions' => array('Meeting.' . $this->Meeting->primaryKey => $meet_id, 'Meeting.type' => 3));
